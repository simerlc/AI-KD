...
export function SignIn() {
  ...
  const { local: hasLocal } = getEnabledAuthProviders()
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>使用本地账户登录以继续。</DialogDescription>
          </DialogHeader>
          ...
          <div className="flex flex-col gap-3 py-4">
            ...
            {hasLocal && (
              <form onSubmit={handleLocalSubmit} className="flex flex-col gap-3">
                ...
                <Button type="submit" disabled={loadingLocal} size="lg" className="w-full">
                  {loadingLocal ? (
                    <>
                      <Spinner />
                      正在加载...
